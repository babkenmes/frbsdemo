...
app.use("/polymer",express.static(path.join(__dirname, 'public/polymer')));
app.use("/polymer/bower_components",express.static(path.join(__dirname, 'public/polymer/bower_components')));
