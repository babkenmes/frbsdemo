...
'use strict';
app.controller('MainCtrl', ['$scope', '$state', 'authService', '$timeout', 'localStorageService', 'roleNames','$location', function ($scope, $state, authService, $timeout, localStorageService, roleNames, $location) {
